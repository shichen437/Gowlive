...
func GetRegularInterval(ctx context.Context, liveId int, platform string) int {
	...
	return utils.RandomSecondsBatesInt(30, 90, 3)
}

// 探测间隔，介于常规间隔和非直播时段间隔之间, 5min-7min
func getDetectInterval() int {
	return utils.RandomSecondsBatesInt(300, 420, 4)
}

// 非直播时段, 12-14min
func getNonLiveInterval() int {
	return utils.RandomSecondsBatesInt(60*12, 60*14, 5)
}
