        ...
        <div class="grid gap-4 py-4">
          <FormField v-slot="{ componentField, errorMessage }" name="roomUrl">
            <FormItem>
              ...
              <FormControl>
                <Input
                  type="text"
                  :placeholder="t('stream.rooms.placeholder.roomUrl')"
              ...
              <FormItem>
                ...
                <Select v-bind="componentField">
                  <FormControl>
                    ...
                    >
                      <SelectValue
                        :placeholder="t('stream.rooms.placeholder.format')"
                      />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent class="w-[--radix-select-trigger-width]">
                    ...
                    <SelectItem value="mp3">{{
                      t('stream.rooms.fields.onlyAudio')
                    }}</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              ...
              <FormItem>
                ...
                <Select v-bind="componentField">
                  <FormControl>
                    ...
                    >
                      <SelectValue
                        :placeholder="t('stream.rooms.placeholder.quality')"
                      />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent class="w-[--radix-select-trigger-width]">
                    <SelectItem :value="0"
                      >{{ t('stream.rooms.fields.quality.original') }}
                    </SelectItem>
                    <SelectItem :value="1">{{
                      t('stream.rooms.fields.quality.super')
                    }}</SelectItem>
                    <SelectItem :value="2">{{
                      t('stream.rooms.fields.quality.high')
                    }}</SelectItem>
                    <SelectItem :value="3"
                      >{{ t('stream.rooms.fields.quality.medium') }}
                    </SelectItem>
                    <SelectItem :value="4">{{
                      t('stream.rooms.fields.quality.low')
                    }}</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              ...
              <FormItem>
                ...
                <Select v-bind="componentField">
                  <FormControl>
                    ...
                    >
                      <SelectValue
                        :placeholder="t('stream.rooms.placeholder.segment')"
                      />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent class="w-[--radix-select-trigger-width]">
                    <SelectItem :value="0">{{
                      t('stream.rooms.fields.segmentNone')
                    }}</SelectItem>
                    <SelectItem :value="900"
                      >15 {{ t('common.fields.minute') }}</SelectItem
                    >
                    <SelectItem :value="1800"
                      >30 {{ t('common.fields.minute') }}</SelectItem
                    >
                    <SelectItem :value="3600"
                      >1 {{ t('common.fields.hour') }}</SelectItem
                    >
                    <SelectItem :value="7200"
                      >2 {{ t('common.fields.hour') }}</SelectItem
                    >
                    <SelectItem :value="14400"
                      >4 {{ t('common.fields.hour') }}</SelectItem
                    >
                  </SelectContent>
                </Select>
                <FormMessage />
          ...
          <template v-if="values.monitorType === 2">
            <div class="grid grid-cols-2 gap-4">
              ...
              >
                <FormItem>
                  <FormLabel>{{
                    t('stream.rooms.fields.monitorStartTime')
                  }}</FormLabel>
                  <FormControl>
                    <VueDatePicker
                      v-bind="componentField"
              ...
              >
                <FormItem>
                  <FormLabel>{{
                    t('stream.rooms.fields.monitorEndTime')
                  }}</FormLabel>
                  <FormControl>
                    <VueDatePicker
                      v-bind="componentField"
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            >
              <FormItem>
                <FormLabel>{{
                  t('stream.rooms.fields.monitorOnly')
                }}</FormLabel>
                <Select v-bind="componentField">
                  <FormControl>
                    <SelectTrigger
            ...
            >
              <FormItem>
                ...
                <FormControl>
                  <Input
                    type="text"
                    :placeholder="t('stream.rooms.placeholder.syncPath')"
                    v-bind="componentField"
                    :class="{ 'border-red-500': errorMessage }"
                  />
                </FormControl>
            ...
            <FormField v-slot="{ componentField, errorMessage }" name="remark">
              <FormItem>
                ...
                <FormControl>
                  <Input
                    type="text"
                    :placeholder="t('stream.rooms.placeholder.remark')"
                    v-bind="componentField"
                    :class="{ 'border-red-500': errorMessage }"
                  />
                </FormControl>
...
const dialogTitle = computed(() =>
  isEditMode.value ? t('stream.rooms.edit.title') : t('stream.rooms.add.title'),
);
    ...
    .object({
      ...
      monitorStartAt: z
        ...
        .regex(/^([01]\d|2[0-3]):([0-5]\d)$/, {
          message: t('stream.rooms.valid.timeFormat'),
        })
        .optional()
        .nullable(),
      monitorStopAt: z
      ...
      syncPath: z
        .string()
        .max(255, { message: t('stream.rooms.valid.syncPathLength') })
        .optional()
        .nullable(),
    })
    .refine(
