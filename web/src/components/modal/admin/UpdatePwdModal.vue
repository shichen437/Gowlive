    ...
    <DialogContent class="sm:max-w-[425px]">
      ...
      <form @submit="onSubmit" class="space-y-4">
        <FormField v-slot="{ componentField }" name="oldPwd">
          <FormItem>
            <FormLabel>{{
              t('user.profile.password.fields.oldPwd')
            }}</FormLabel>
            <FormControl>
              <Input
                type="password"
                v-bind="componentField"
                :placeholder="t('user.profile.password.placeholder.oldPwd')"
              />
            </FormControl>
            <FormMessage />
          </FormItem>
        ...
        <FormField v-slot="{ componentField }" name="newPwd">
          <FormItem>
            <FormLabel>{{
              t('user.profile.password.fields.newPwd')
            }}</FormLabel>
            <FormControl>
              <Input
                type="password"
                v-bind="componentField"
                :placeholder="t('user.profile.password.placeholder.newPwd')"
              />
            </FormControl>
            <FormMessage />
          </FormItem>
        ...
        <FormField v-slot="{ componentField }" name="confirmPwd">
          <FormItem>
            <FormLabel>{{
              t('user.profile.password.fields.confirmPwd')
            }}</FormLabel>
            <FormControl>
              <Input
                type="password"
                v-bind="componentField"
                :placeholder="t('user.profile.password.placeholder.confirmPwd')"
              />
            </FormControl>
            <FormMessage />
          </FormItem>
...
const formSchema = toTypedSchema(
  z
    .object({
      ...
      confirmPwd: z
        .string()
        .min(1, t('user.profile.password.valid.confirmPwd')),
    })
