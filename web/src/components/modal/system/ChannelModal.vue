<template>
  <Dialog v-model:open="open">
    <DialogContent class="sm:max-w-[600px]">
      <DialogHeader>
        <DialogTitle
          >{{ isEdit ? t('common.fields.edit') : t('common.fields.add')
          ...
          <FormField name="name" v-slot="{ componentField }">
            <FormItem>
              ...
              <FormControl>
                <Input
                  type="text"
                  :placeholder="t('system.channel.placeholder.name')"
        ...
        <div class="grid grid-cols-2 gap-4">
              ...
              >
                <FormControl>
                  <SelectTrigger class="w-full">
                    <SelectValue
                      :placeholder="t('system.channel.placeholder.type')"
                    />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
                  ...
                  <SelectItem value="dingTalk"
                    >{{ t('system.channel.fields.channel.dingTalk') }}
                  </SelectItem>
          ...
          <FormField name="remark" v-slot="{ componentField }">
            <FormItem>
              ...
              <FormControl>
                <Input
                  :placeholder="t('system.channel.placeholder.remark')"
                  v-bind="componentField"
                />
              </FormControl>
              <FormMessage />
          ...
          <FormField name="email.authCode" v-slot="{ componentField }">
            <FormItem>
              ...
              <FormControl>
                <Input
                  type="password"
                  :placeholder="t('system.channel.placeholder.authCode')"
                  v-bind="componentField"
                />
              </FormControl>
              <FormMessage />
