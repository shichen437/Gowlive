<template>
    <Sheet>
        ...
        <SheetContent>
            ...
            <Tabs default-value="appearance" class="grid flex-1 auto-rows-min gap-6 px-4">
                <TabsList class="w-full">
                    <TabsTrigger value="appearance" class="w-full">{{ t('project.topbar.sheet.tabs.appearance') }}
                    </TabsTrigger>
                    <TabsTrigger value="shortcuts" class="w-full">{{ t('project.topbar.sheet.tabs.shortcuts') }}
                    </TabsTrigger>
                </TabsList>
                <TabsContent value="appearance">
                    ...
                    <div class="grid gap-3 mt-6">
                        ...
                        <RadioGroup :model-value="locale" @update:model-value="changeLocale"
                            class="grid grid-cols-3 gap-2">
