      ...
      >
        <TabsList class="w-full">
          <TabsTrigger value="appearance" class="w-full"
            >{{ t('project.topbar.sheet.tabs.appearance') }}
          </TabsTrigger>
          <TabsTrigger value="shortcuts" class="w-full"
            >{{ t('project.topbar.sheet.tabs.shortcuts') }}
          </TabsTrigger>
        </TabsList>
        <TabsContent value="appearance">
          <div class="grid gap-3">
            <Label class="font-medium">{{
              t('project.topbar.sheet.fields.appearance')
            }}</Label>
          ...
          <div class="grid gap-3 mt-6">
            <Label class="font-medium">{{
              t('project.topbar.sheet.fields.theme')
            }}</Label>
            <RadioGroup
              :model-value="theme"
          ...
          <div class="grid gap-3 mt-6">
            <Label class="font-medium">{{
              t('project.topbar.sheet.fields.language')
            }}</Label>
            <RadioGroup
              :model-value="locale"
