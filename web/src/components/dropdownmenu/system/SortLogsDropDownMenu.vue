<template>
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end">
      <DropdownMenuItem
        @click="handleSortChange('id:desc')"
      ...
      <DropdownMenuItem
        @click="handleSortChange('status:desc')"
      ...
      <DropdownMenuItem
        @click="handleSortChange('status:asc')"
      ...
      <DropdownMenuItem
        @click="handleSortChange('type:desc')"
      ...
      <DropdownMenuItem
        @click="handleSortChange('type:asc')"
