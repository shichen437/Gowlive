        ...
        <Card class="w-full max-w-md border-0 shadow-none">
          ...
          <CardContent class="grid gap-4">
            <div class="grid gap-2">
              <Label for="username">{{
                t('project.login.fields.username')
              }}</Label>
              <Input
                id="username"
                v-model="username"
                type="text"
                :placeholder="t('project.login.placeholders.username')"
                required
              />
            </div>
            <div class="grid gap-2">
              <Label for="password">{{
                t('project.login.fields.password')
              }}</Label>
              <Input
                id="password"
                v-model="password"
