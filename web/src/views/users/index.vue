    ...
    <div class="md:col-span-1">
      <nav class="space-y-1 py-4">
        <Button
          ...
          :class="{
            'bg-accent text-accent-foreground': activeView === 'account',
          }"
        ...
        <Button
          ...
          class="w-full justify-start"
          :class="{
            'bg-accent text-accent-foreground': activeView === 'live-settings',
          }"
        ...
        <Button
          ...
          class="w-full justify-start"
          :class="{
            'bg-accent text-accent-foreground': activeView === 'sync-settings',
          }"
    ...
    <div class="md:col-span-3">
      <div v-if="activeView === 'account'">
        <Card>
          ...
          >
            <div
              class="md:col-span-1 flex flex-col items-center justify-center space-y-4"
            >
            ...
            <div class="md:col-span-3 space-y-4">
              <div class="flex items-center">
                <span class="w-20 text-sm text-muted-foreground">{{
                  t('user.profile.fileds.username')
                }}</span>
              ...
              <div class="flex items-center">
                <span class="w-20 text-sm text-muted-foreground">{{
                  t('user.profile.fileds.nickname')
                }}</span>
                <p class="ml-auto">{{ userInfo?.nickname }}</p>
              </div>
              <div class="flex items-center">
                <span class="w-20 text-sm text-muted-foreground">{{
                  t('user.profile.fileds.gender')
                }}</span>
                <div class="ml-auto text-right">
                  <Mars
                    v-if="userInfo?.sex === 1"
