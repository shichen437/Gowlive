<template>
        ...
        <TableHeader>
          <TableRow>
            <TableHead class="text-center">{{
              t('system.notify.fields.level')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('common.fields.title')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('common.fields.content')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('system.notify.fields.time')
            }}</TableHead>
            <TableHead class="text-center">{{
        ...
        <TableBody>
          <template v-if="notifys.length > 0">
            ...
            >
              ...
              <TableCell class="text-center">
                <Button
                  v-if="notify.status === 0"
                  variant="ghost"
                  size="icon"
                  class="text-blue-500 hover:text-blue-600"
                  @click="handleMarkRead(notify.id)"
                >
  ...
  <ConfirmModal
    ...
    :onOpenChange="(open: any) => (showConfirmDeleteModal = open)"
  ...
  <ConfirmModal
    ...
    :onConfirm="handleDeleteAllNotifys"
    :title="t('system.notify.allDelete.title')"
    :description="t('system.notify.allDelete.desc')"
  />
  <ConfirmModal
    :open="showConfirmMarkAllModal"
    :onOpenChange="(open: any) => (showConfirmMarkAllModal = open)"
    :onConfirm="handleMarkAllRead"
    :title="t('system.notify.allRead.title')"
