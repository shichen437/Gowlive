    ...
    <div class="w-1/4 border-l p-2 flex flex-col">
      <div class="border rounded-lg grow">
        <Table>
          ...
          <TableBody>
            <TableRow
              v-for="preview in previewListItems"
              :key="preview.id"
              @click="playPreview(preview.id)"
              :class="{
                'text-blue-600 dark:text-blue-300':
                  preview.id === currentPlayingId,
                'cursor-pointer': preview.id !== currentPlayingId,
              }"
            >
              <TableCell>
                <div class="truncate">
