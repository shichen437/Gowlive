      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead class="text-center">{{
              t('stream.history.fields.startTime')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('stream.history.fields.endTime')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('stream.history.fields.duration')
            }}</TableHead>
            <TableHead class="text-center">{{
