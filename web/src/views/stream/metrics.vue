        ...
        <CardContent>
          <div class="grid grid-cols-2 gap-2 text-sm">
            <div class="text-muted-foreground">
              {{ t('stream.metrics.totalReqCount') }}
            </div>
            <div class="font-semibold text-right">
              {{ metric.totalRequests }}
            </div>
            <div class="text-muted-foreground">
              {{ t('stream.metrics.totalFailedCount') }}
            </div>
            <div class="font-semibold text-right">{{ metric.totalErrors }}</div>
            <div class="text-muted-foreground">
              {{ t('stream.metrics.totalFailedRate') }}
            </div>
            <div
            ...
            <div class="text-muted-foreground">
              {{ t('stream.metrics.mainReqCount') }}
            </div>
            <div class="font-semibold text-right">
              {{ metric.mainRequests }}
            </div>
            <div class="text-muted-foreground">
              {{ t('stream.metrics.mainFailedCount') }}
            </div>
            <div class="font-semibold text-right">{{ metric.mainErrors }}</div>
            <div class="text-muted-foreground">
              {{ t('stream.metrics.mainFailedRate') }}
            </div>
            <div
              class="font-semibold text-right"
              :class="
