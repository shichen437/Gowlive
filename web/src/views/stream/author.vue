      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead class="text-center">{{
              t('stream.anchor.fields.sign')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('stream.anchor.fields.following')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('stream.anchor.fields.followers')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('stream.anchor.fields.likes')
            }}</TableHead>
            <TableHead class="text-center">{{
              t('stream.anchor.fields.videos')
            }}</TableHead>
            <TableHead class="text-center">{{
            ...
            <TableRow v-for="anchor in anchors" :key="anchor.id">
              <TableCell class="text-center">
                <Badge variant="outline">{{
                  getPlatformLabel(anchor.platform)
                }}</Badge>
              </TableCell>
              ...
              <TableCell class="text-center"
                >{{ formatBigNumber(anchor.followerCount, locale) }}
              </TableCell>
              <TableCell class="text-center">{{
                formatBigNumber(anchor.likeCount, locale)
              }}</TableCell>
