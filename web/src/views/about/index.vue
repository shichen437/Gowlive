  ...
  <div class="space-y-4">
    <Card>
      ...
      <CardContent>
        ...
        <br />
        <p class="text-slate-500 underline">
          {{ t('project.about.intro.security') }}
        </p>
      </CardContent>
    </Card>
      ...
      <CardContent>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <p class="flex items-center truncate">
            ...
            {{ t('project.about.info.sourceCode') }}:
            <a
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a
              href="https://gitee.com/shichen437/Gowlive"
              target="_blank"
              class="text-slate-500 hover:underline ml-1"
              >Gitee</a
            >
          ...
          <p class="flex items-center truncate">
            ...
            {{ t('project.about.info.website.title') }}:
            <a
              href="https://shichen437.github.io"
              target="_blank"
              class="text-slate-500 hover:underline ml-1"
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <a
              href="https://gowlive-6b1dv010m.maozi.io"
              target="_blank"
              class="text-slate-500 hover:underline ml-1"
      ...
      <div class="flex space-x-8">
        <div class="flex flex-col items-center">
          ...
          <p class="text-center mt-2">
            {{ t('project.about.support.alipay') }}
          </p>
        </div>
        <div class="flex flex-col items-center">
          <img
          ...
          />
          <p class="text-center mt-2">
            {{ t('project.about.support.wechat') }}
          </p>
        </div>
      </div>
    </div>
